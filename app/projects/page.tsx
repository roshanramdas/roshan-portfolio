...
export default async function ProjectsPage() {
  ...
  const featured = allProjects.find((project) => project.slug === "ice")!;
  const top2 = allProjects.find((project) => project.slug === "credit-agricole")!;
  const top3 = allProjects.find((project) => project.slug === "cropwise")!;
    ...
    <div className="relative pb-16">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        ...
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-4 text-zinc-400">
            Some of the moments I have captured!
          </p>
        </div>
        <div className="w-full h-px bg-zinc-800" />
        <SwipeableCard data={imageData} />
      </div>
    </div>
  );
}
